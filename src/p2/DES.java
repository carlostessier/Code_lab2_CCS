...
/**
 * DemostraciÛn de cifrado DES con Bouncy Castle
 */
public class DES {
	...
	/**
	 * Gestiona la creaciÛn de una clave DES
	 */
	 ...
	 * alamcenada tambi√©n en otro archivo
	 */
	 ...
	 * almacenada tambiÈn en otro archivo
	 */
	...
	/**
	 * Realiza el descifrado DES de los datos Este m√©todo podr√≠a obviarse y
	 * utilizarse el m√©todo encrypt para realizar el descifrado al ser el
	 * algoritmo DES un algoritmo sim√©trico, pero se mantiene por criterios de
	...
	/**
	 * Genera una Clave para el cifrado DES a partir de un n√∫mero aleatorio
	 * "seguro"
	 * 
	...
	public byte[] generateKey() {
		...
		try {
			sr = new SecureRandom();
			// por seguridad no deberÌa utilizarse semilla
